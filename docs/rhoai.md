...
3) Access the `workbench` named `test-nov28-fouronefive-notebook`.
...
5) In the terminal, run `cd test-nov28-fouronefive` to navigate to your sample app's directory.
